...
{
    public $arr = array();
    public $table_id = ""; //html id for the table
    public $table_class = ""; //html class for the table
    public $tabela = ""; //tabela do ser utilizada
    ...
    public function output()
    {
        ...
        $table_class = "";
        if ($this->table_class != "") {
            $table_class = "class='{$this->table_class}'";
        }
        $td_class = "";
        if ($this->td_class != "") {
            $td_class = "class='{$this->td_class}'";
        }
